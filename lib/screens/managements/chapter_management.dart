    ...
    for (var docSnap in querysnapshot.docs) {
      ...
      model.courses?.forEach((element) {
        ...
        for (int j = 0; j < element.batches!.length; j++) {
          _batchList.add(element.batches?.elementAt(j));
        }
      });
    }
                            ...
                            child: Container(
                                  ...
                                  child: DropdownButtonHideUnderline(
                                    child: DropdownButton(
                                      ...
                                      items: _allCourse.map((item) => DropdownMenuItem<String>(
                                        value: item,
                                        child: Text(item!)
                                      )).toList(),
                                    ...
                                    child: DropdownButton(
                                      icon: const Visibility(
                                          ...
                                          child:
                                              Icon(Icons.keyboard_arrow_down)),
                                      value: _chapterBatch,
                                      items: _batchList.map((item) => DropdownMenuItem<String>(
                                        value: item,
                                        child:Text(item!)
                                      )).toList(),
